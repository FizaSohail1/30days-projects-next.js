...
function UnitConverter() {
  ...
  return (
    ...
    <div className="max-w-md w-full p-6 bg-card rounded-lg shadow-lg">
      ...
      <p className="text-sm mb-8 text-center"> Convert values between different units.</p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Button type="button" className="col-span-2 bg-primary text-primary-foreground hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring" onClick={convertValue}> Convert</Button>
      </div>
